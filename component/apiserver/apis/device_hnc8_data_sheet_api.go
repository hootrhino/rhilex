...
func Hnc8SheetPageList(c *gin.Context, ruleEngine typex.Rhilex) {
...
*
 */
func Hnc8SheetDeleteAll(c *gin.Context, ruleEngine typex.Rhilex) {
	type Form struct {
...
*
 */
func Hnc8SheetDelete(c *gin.Context, ruleEngine typex.Rhilex) {
	type Form struct {
		UUIDs      []string `json:"uuids"`
		DeviceUUID string   `json:"device_uuid"`
	}
...
*
 */
func Hnc8SheetUpdate(c *gin.Context, ruleEngine typex.Rhilex) {
	type Form struct {
		DeviceUUID     string        `json:"device_uuid"`
...
func Hnc8SheetImport(c *gin.Context, ruleEngine typex.Rhilex) {
